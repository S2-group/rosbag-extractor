...
if [ -z "$2" ]; then
    echo "Use the following command: ./extractor.sh <ros_version> [<start_time>] [<end_time>] <bag_file> <filetype>"
#  python3
elif [ -z "$3" ]; then
